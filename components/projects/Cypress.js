...
export default function Cypress() {
  return (
    <ProjectCard
      title="CypressIO (Javascript) UI Automation"
    ...
    >
      ...
      <p><strong>Description:</strong> Designing, Developing & Maintaining CypressIO UI Automation Framework from Scratch to Architecture level.</p>
      <p><strong>TechStack:</strong> This framework consists of following list: CypressIO API, JavaScript, NodeJS, Mocha, Chai, Page Object Model, Data Driven Concept.</p>
