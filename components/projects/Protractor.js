...
export default function Protractor() {
  return (
    <ProjectCard
      title="Protractor UI Automation"
    ...
    >
      ...
      <p><strong>Description:</strong> Designing, Developing & Maintaining Protractor UI Automation Framework from Scratch to Architecture level.</p>
      <p><strong>TechStack:</strong> This framework consists of following list: Protractor API, JavaScript, NodeJS, Mocha, Chai, Page Object Model, Data Driven Concept.</p>
